...
const Modal: React.FC<ModalProps> = ({
  ...
  return createPortal(
    <React.Fragment>
      {/* //? modal wrapper/mask */}
      <div className="fixed inset-0 flex  transition-opacity z-50">
        ...
        >
          <Button
            className="absolute after:content-['\00d7'] text-slate-600 size-8 right-5 top-2 bg-transparent hover:bg-gray-200 hover:text-slate-600 transition duration-150 z-50"
            appearance="text"
            shape="circle"
            size="large"
            onClick={onClose}
