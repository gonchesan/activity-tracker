    ...
    formData && (
      <div className="mt-4 grid grid-cols-4 gap-4 grid-flow-row-dense">
        <div className="col-span-4">
          <label htmlFor="description" className="block text-sm font-semibold leading-6 text-gray-600">
            Description
          </label>
        ...
        <div className="col-span-2 sm:col-span-4 md:col-span-4 lg:col-span-2 relative">
          <label htmlFor="begin_time" className="block text-sm font-semibold leading-6 text-gray-600">
            Begin time
          </label>
          <div className="mt-2.5">
            <TimeField
              ...
              input={
                <input
                  className="col-span-2 w-full border border-slate-200 rounded-md px-10 py-2 ring-1 ring-inset ring-gray-300 focus:ring-teal-600 focus:ring-2 focus:ring-inset outline-none"
                  value={begin_time}
                  name="begin_time"
                  type="text"
                />
        ...
        <div className="col-span-2 sm:col-span-2 md:col-span-4 lg:col-span-2 relative">
          <label htmlFor="end_time" className="block text-sm font-semibold leading-6 text-gray-600">
            End time
          </label>
          <div className="mt-2.5">
            <TimeField
